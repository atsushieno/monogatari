...
author: atsushieno
timezone: "Asia/Tokyo"
description: "Connect2016のQ&AセッションでMiguelが質問されて回答していたので、前々から（.NET Fringe Japanの頃から）書こうと思っていたネタをざっくり書こうと思います。 .NET CoreはMonoの代わりにはなりません。 .NET Coreは「クロスプラットフォームの.NET Framewo..."
