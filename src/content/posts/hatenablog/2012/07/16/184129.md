...
author: atsushieno
timezone: "Asia/Tokyo"
description: "MonoDevelopにはバージョン管理サポートがアドインとして入っていて、gitとsubversionがサポートされている。svnサポートは使ったことがないので、gitしか分からないのだけど、既に任意のリビジョンに復元できたり、blameできたり、新旧のリビジョンを比較できたり、ローカルの変更を追跡できたりする..."
