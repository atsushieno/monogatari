...
author: atsushieno
timezone: "Asia/Tokyo"
description: "今週末のCOSCUP 2024のスライドの準備でテンパってるので（順調ではない）、手短にいきます。 ktmidi 0.9.0 and AAP 0.9.0 先月の時点でKotlin 2.0対応は済ませてありましたが、さらにmacOS用のCoreMidi2Accessの実装が何とか動くようになって、AlsaMidiA..."
