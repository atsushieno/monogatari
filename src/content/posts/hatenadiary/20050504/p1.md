...
author: atsushieno
timezone: "Asia/Tokyo"
description: "とりあえずGW中にDTLLを進めるのはやめとこうかなあと思う。 XPathで書くと list/zeroOrMore/regex みたいなparseの内容があったとき、propertyへのbindingはどうなるのかが不明。 そもそも現在の仕様は非決定的内容モデルも受理するので、先頭からparsingを行うという規..."
