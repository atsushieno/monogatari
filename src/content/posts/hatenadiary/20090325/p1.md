...
author: atsushieno
timezone: "Asia/Tokyo"
description: "こんなん作っちゃいました。↓ボタンを押してoggを選択すると再生できます（再生するだけw） Silverlight3ではraw PCM（を含むカスタムメディアストリーム）が使える、でもmanaged codeで書いてある必要があるからすぐには実装が出てこなそうだ…というので、そんだったらもしかしてcsvorbis..."
