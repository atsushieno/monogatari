...
author: atsushieno
timezone: "Asia/Tokyo"
description: "もしあなたがGetSortKey()を使っていて、''と'−'を正しく違う文字として比較したかったら、CompareOptions.StringSortを指定しなければならない。 StringSortによって影響を受ける文字はそれほど多くない。と思う。少なくとも僕が実験した範囲では以下の4種類だ: コントロール文..."
