...
author: atsushieno
timezone: "Asia/Tokyo"
description: "前回は導入、childDerivおよびchildrenDerivについての解説で終わってしまったので、今回は、実際のパターン（内容モデル、みたいなもの）のvalidationについて、導入的な説明を試みる。 RELAX NGのパターンとXML Schemaの内容モデル XML Schemaでは、内容モデルとは、要..."
