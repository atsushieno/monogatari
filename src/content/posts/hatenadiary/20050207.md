...
author: atsushieno
timezone: "Asia/Tokyo"
description: "■ こういうの読んでると、うちもナントカ秘密基金作った方がええかいな…とか（ぉぃ n v d l 何となくNVDLの実装よりRELAX NG実装のbugfixに終始してしまった気がしなくもない。現在もむしろそっちではまっている。けど、とりあえず何も動かせるコードが無かった先週よりはずっとイイ感じだ。ADO.NET..."
