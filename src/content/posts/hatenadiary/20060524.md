...
author: atsushieno
timezone: "Asia/Tokyo"
description: "Generational GC hitting svn generational GCのコードの大半がsvnにcheckinされたみたい。configure.inとかcorlib辺りはまだ入っていないし、ビルドしても有効にならない。はず。それと、現状ではpthreadに依存しているので、mono on Windo..."
