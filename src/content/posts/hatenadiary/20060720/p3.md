...
author: atsushieno
timezone: "Asia/Tokyo"
description: "今さらな話かもしれないけど。 昨日の雑談meetingで、.NET開発にCLR Profilerを使ってみたら呼び出し回数とかいろいろ分かって便利だった、という話が出てきた。その時も少し話したのだけど、これはmonoでも簡単だ。monoを実行するときに profile オプションを付けて実行すると、終わった後で膨..."
