...
author: atsushieno
timezone: "Asia/Tokyo"
description: "これは <http://monodroid.net/Documentation/APIDesign の現時点での日本語訳。 概要 MonoDroidでは、Monoのコア基本クラスライブラリに加えて、さまざまなAndroid APIのバインディングを提供しており、これによってネイティブAndroidアプリケーション..."
