...
author: atsushieno
timezone: "Asia/Tokyo"
description: "これは <http://monodroid.net/FAQ の現時点での内容の日本語訳、をもとに書いたもの。 基本 MonoDroidとは何ですか? MonoDroidは、Androidベースのデバイス向けにCを使ってモバイルアプリケーションを書けるようにしたSDKです。 MonoDroidは2つのAPIの集合を..."
