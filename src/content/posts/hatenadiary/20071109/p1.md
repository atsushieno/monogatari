...
author: atsushieno
timezone: "Asia/Tokyo"
description: "小ネタに便乗するにょ。 <http://d.hatena.ne.jp/ladybug/20071109p2 僕ならWriteString()をオーバーライドしてWriteStateがAttributeでない時だけWriteCData()を呼び出す、特別なXmlWriterを作るかな。 ただ、WriteCData(..."
