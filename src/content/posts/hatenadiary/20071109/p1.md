...
author: atsushieno
timezone: "Asia/Tokyo"
description: "小ネタに便乗するにょ。 僕ならWriteString()をオーバーライドしてWriteStateがAttributeでない時だけWriteCData()を呼び出す、特別なXmlWriterを作るかな。 ただ、WriteCData()とWriteString()の動作は等価ではない。僕が書いたXmlTextWrit..."
