...
author: atsushieno
timezone: "Asia/Tokyo"
description: "先週末にふと思い立ってやっつけでWCF 4.0 Routingを実装したので、ざっくりとした話を書こうと思う。ちなみにまだ完成してはいない。configurationまわりは途中までしか作っていない。内部動作の説明は例によってMonoのものであって.NETのものは知らない。 WCF Routingは、クライアント..."
