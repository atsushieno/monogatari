...
author: atsushieno
timezone: "Asia/Tokyo"
description: "startTagOpenDeriv (OneOrMore p) (OneOrMore p)は、(Group p (Choice Empty (OneOrMore p)))であると考えれば、他のパターンの定義に吸収することができる。すなわち、(OneOrMore p)にstartTagOpenDerivを適用した結..."
