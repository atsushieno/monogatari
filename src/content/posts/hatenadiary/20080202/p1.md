...
author: atsushieno
timezone: "Asia/Tokyo"
description: ".NET 3.5のSystem.ServiceModel.Web.dllには、JSONをサポートするXmlReader/XmlWriterがある。しかし、これが実際にはどういう振る舞いを見せるかは、どこにも書かれていない。というわけで個人的な説明をまとめてみる。 内容の種類にかかわらず、document elem..."
