...
author: atsushieno
timezone: "Asia/Tokyo"
description: "今北産業 ゴールデンウィーク中にMono for AndroidでOgg Vorbisプレイヤーを作っていたのですが、何とか実用的なところまで出来上がったので、Android Marketで公開しました: ソースコードはgithubに置いてあります: 既存のメディアプレイヤーで、このFalplayerと同じ機能を..."
