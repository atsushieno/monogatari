...
author: atsushieno
timezone: "Asia/Tokyo"
description: "MonoTouchで使われたテクノロジーを使った新しいCocoaバインディングが公開されたようです。CocoaTouchじゃなくてCocoa、つまりMac OSXアプリの開発に使う方ですね。 やっていることはほとんどMonoTouchと同じで（と説明文を見るに思う）、public APIに対するP/Invokeを..."
