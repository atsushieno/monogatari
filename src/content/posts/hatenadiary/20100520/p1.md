...
author: atsushieno
timezone: "Asia/Tokyo"
description: "Google I/O のkeynoteで、native clientの動作例としてUnityが登場しましたね。 <http://www.youtube.com/GoogleDevelopers そんなわけで、monoはnacl上でも動作するようです。 naclでは実行できるCPU命令が限られているので、nacl上..."
